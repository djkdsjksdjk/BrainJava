...
</html><%@ page import="java.sql.*,oracle.dbpool.*"  %>
...
<br>
	...
	<table border=0 width=550 height=30 bordercolor=black>
		...
		<tr>
			...
			<td align=center ><font size=5 color=gray><b>◎ 내 게 시 판</b></td>
	...
	<table width=650 border=1 cellspacing=0 cellpadding=0  bordercolor="#C0C0C0">
