...
<br>
   <table border=1 width=550 height=30 bordercolor=gray>
      <tr>
<td align=center bgcolor=0063ce><font size=3 color=#FFFFFF><b>자 유 게 시 판</b></td>      </tr>
     </tr>
   </table>
   <br>
               <table width="550" border="1" cellspacing="0" cellpadding="0" bordercolor="#C0C0C0" >
      <tr bgcolor="#7eaee9" height=21>
         <td width=70 align="center" bgcolor="#7EAEE9"><font size="3" >번호</font></td>
         <td width=230  align="center">제목</td>
         <td width=120 align="center">날짜</td>
