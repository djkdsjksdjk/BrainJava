...
<HTML>
	...
	<!-- <link href="../common/dataTables.bootstrap.min.css" type=text/css rel=stylesheet>
	<link href="../common/bootstrap.min.css" type=text/css rel=stylesheet> -->
