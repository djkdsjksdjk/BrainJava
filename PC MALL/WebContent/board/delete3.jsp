...
<%! 
	static Logger logger = Logger.getLogger("delete3.jsp"); 
%>
...
<%
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("select pwd from re_board2 where b_id="+b_id);
		...
		if(pwd.equals(request.getParameter("pwd"))){ 
			...
			stmt2.executeUpdate("delete from re_board2 where b_id="+b_id);
%>
			<script language=javascript>
				document.location.href='Boarde_list.jsp';
			</script>
<%
		} else {
%>
