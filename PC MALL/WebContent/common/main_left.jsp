...
<table width=125 border=0 cellspacing=0 cellpadding=0 align=left height=90>
   <tr>
      <td height=22 valign=middle align=center><img src="../img/product_insert.jpg" width=150 height=60  style="cursor:hand" onclick=location="../board/board_list2.jsp"></td>
   </tr>
     </table>
<table>
<tr height="8"><td></td></tr>
...
<img src="../img/category_top.jpg" width="150" height="30" border="0" style="
    width: 123x;
    height: 33px;
">
</table>

<table width=125 border=0 cellspacing=0 cellpadding=0 align=left height=300>
...
<div id="pc" style="position:absolute; left:265px; top:410px; width:100px; z-index:200; visibility: hidden"> 
...
<div id="software" style="position:absolute; left:265px; top:450px; width:100px; z-index:200; visibility: hidden"> 
...
<div id="network" style="position:absolute; left:265px; top:500px; width:100px; z-index:200; visibility: hidden"> 
...
<div id="digital" style="position:absolute; left:265px; top:550px; width:100px; z-index:200; visibility: hidden"> 
...
<div id="etc" style="position:absolute; left:265px; top:600px; width:90px; z-index:100; visibility: hidden"> 
...
<div id="etc" style="position:absolute; left:265px; top:710px; width:100px; z-index:200; visibility: hidden"> 
  <table width=110 border=1 cellspacing=2 cellpadding=0 bgcolor="#9ba9d7" onMouseOver="MM_showHideLayers('computer','','hide','pc','','hide','software','','hide','network','','hide','digital','','hide','etc','','show')" onMouseOut="MM_showHideLayers('computer','','hide','pc','','hide','software','','hide','network','','hide','digital','','hide','etc','','hide')">
   <tr>
       <td onmouseover="this.style.background='#d4d8e8'" style="padding-top: 2px" onmouseout="this.style.background='#eef0f8'" width=94  bgcolor=#eef0f8><a href="../product/category.jsp?c=19"  target=_top>&nbsp;&nbsp;저장미디어</a></td></tr>
   <tr>
...
<img src="../img/category_bottom.jpg" width="150px" height="30" border="0" style="
    width: 220x;
   
">


<table width=150 border=1 cellspacing=0 cellpadding=0 align=left height=200>
<tr>
<td><img src="../img/main_window left.JPG" width=150 height=200></td>
   </tr>
     </table>
</body>