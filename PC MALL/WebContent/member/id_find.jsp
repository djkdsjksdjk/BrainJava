...
<BODY >
   ...
   <table  align="center"  width=910 height=20 >
      <tr>
         <td align="center" style="padding-right:150px;" ><font size=6 color=#BDBDBD ><b>-- ID 찾기 -- </b></td>
      </tr>
   </table>
</center>
&nbsp;
...
<table width="250" height=225 border="0" cellspacing="0" cellpadding="1">
                     <tr>
                        <td width="100" nowrap><font size=3>이름</td>
                                  <td width="400" height="50px;">
                           <input type=text name="name" size="16" 
                           maxlength=20   style="width:200px;  height: 18px;"></td>
                     </tr>
                     <tr>
